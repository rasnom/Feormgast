...
ESP32 Home Agriculture Tool 

Currently, this is simply a controller for an automatic 
chicken doop door controller that hosts a Wifi network for 
updates and manual control.
